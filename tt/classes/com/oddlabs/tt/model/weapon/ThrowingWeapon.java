...
public abstract strictfp class ThrowingWeapon extends Accessories implements Animated {
    ...
    private final void calcNumUpdatesAndZSpeed() {
        ...
        time = 0;
        float dest_vec_z =
                owner.getWorld().getHeightMap().getNearestHeight(end_x, end_y)
                        + target.getHitOffsetZ()
                        - (getPositionZ() + deterministic_z);
            ...
            owner.getWorld()
                    ...
                    .newAudio(
                            new AudioParameters(
                                    ...
                                    1f
                                            + (owner.getWorld().getRandom().nextFloat() - .5f)

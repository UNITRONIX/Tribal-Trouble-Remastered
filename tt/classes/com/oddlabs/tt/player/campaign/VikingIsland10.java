    ...
    protected final void start() {
        ...
        local_player.setActiveChieftain(
                new Unit(
                        ...
                        Utils.getBundleString(player_bundle, "chieftain_name"),
                        false));
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header11"),
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header10"),
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header9"),
        ...
        new SceneryModel(
                ...
                0,
                1,
                getViewer().getWorld().getRacesResources().getTreasures()[2],
                shadow_diameter,
                true,
                Utils.getBundleString(bundle, "statue"));
        ...
        new Unit(
                ...
                188 * 2,
                null,
                enemy.getRace().getUnitTemplate(Race.UNIT_WARRIOR_RUBBER));
        new Unit(
                enemy,
                173 * 2,
                188 * 2,

...
public final strictfp class NativeIsland3 extends Island {
    ...
    public final void init(NetworkSelector network, GUIRoot gui_root) {
        String[] ai_names =
                new String[] {
                    Utils.getBundleString(bundle, "name0"),
    ...
    protected final void start() {
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header0"),
        ...
        local_player.setActiveChieftain(
                new Unit(
                        local_player,
                        start_x,
                        start_y,
                        null,
                        local_player.getRace().getUnitTemplate(Race.UNIT_CHIEFTAIN),
                        Utils.getBundleString(player_bundle, "native_chieftain_name"),
                        false));
        ...
        for (int i = 0; i < 5; i++) {
            new Unit(
                    ...
                    start_y,
                    null,
                    local_player.getRace().getUnitTemplate(Race.UNIT_PEON));
        }
        // rest as warriors
        int unit_count =
        ...
        for (int i = 0; i < unit_count; i++) {
            if (getCampaign().getState().getDifficulty() == CampaignState.DIFFICULTY_EASY)
                new Unit(
                        ...
                        start_y,
                        null,
                        local_player.getRace().getUnitTemplate(Race.UNIT_WARRIOR_IRON));
            else
                new Unit(
                        local_player,
                        start_x,
                        start_y,
                        null,
                        local_player.getRace().getUnitTemplate(Race.UNIT_WARRIOR_ROCK));
        }
        ...
        final Runnable dialog8 =
                new Runnable() {
                    public final void run() {
                        // Winning condition
                        new MagicUsedTrigger(
                                local_player.getChieftain(), thor_x, thor_y, 20, 0, prize);
                        changeObjective(1);

                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header8"),
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header7"),
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header6"),
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header5"),
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header4"),
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header3"),
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header2"),
                ...
                new Runnable() {
                    public final void run() {
                        CampaignDialogForm dialog =
                                new InGameCampaignDialogForm(
                                        getViewer(),
                                        Utils.getBundleString(bundle, "header1"),
        ...
        new SceneryModel(
                ...
                dir,
                dir,
                enemy.getRace().getUnitTemplate(Race.UNIT_CHIEFTAIN).getSpriteRenderer(),
                shadow_diameter,
                true,
                Utils.getBundleString(bundle, "god"),
                Unit.ANIMATION_THOR,
                -1f,
                0f);
        ...
        for (int i = 0; i < 30; i++) {
            new Unit(
                    ...
                    135 * 2,
                    null,
                    reinforcements.getRace().getUnitTemplate(Race.UNIT_WARRIOR_IRON));
        }
        ...
        new Unit(
                ...
                155 * 2,
                null,
                enemy.getRace().getUnitTemplate(Race.UNIT_WARRIOR_ROCK));
        new Unit(
                enemy,
                178 * 2,
                145 * 2,
                null,
                enemy.getRace().getUnitTemplate(Race.UNIT_WARRIOR_IRON));
        new Unit(
                enemy,
                178 * 2,
                151 * 2,
                    ...
                    public final void run() {
                        ...
                        if (unit != null && !unit.isDead()) {
                            ...
                            if (new_unit != null && !new_unit.isDead())
                                new_unit.setTarget(
                                        new LandscapeTarget(62, 62), Target.ACTION_DEFAULT, true);
                        }
                    }
                };
        float interval;
